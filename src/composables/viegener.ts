 ...
 */
function isUpperCase (character: any) {
 ...
 */
function encrypt (message: any, key: any) {
  let result = ''
...
const messageEncrypt = encrypt('CRYPTOGRAPHY', 'BREAKBREAKBR')
console.log(messageEncrypt) 
 
const messageDecrypt = decrypt('DICPDPXVAZIP', 'BREAKBREAKBR')
